...
public class QAccountData extends EntityPathBase<AccountData> {
    ...
    private static final long serialVersionUID = 2088686258L;

    private static final PathInits INITS = PathInits.DIRECT2;

    public static final QAccountData accountData = new QAccountData("accountData");

    public final kr.co.leem.jpa.example.entities.account.embedded.QAccountDataPK accountDataPK;
    ...
    public QAccountData(Class<? extends AccountData> type, PathMetadata<?> metadata, PathInits inits) {
        ...
        this.accountDataPK = inits.isInitialized("accountDataPK") ? new kr.co.leem.jpa.example.entities.account.embedded.QAccountDataPK(forProperty("accountDataPK")) : null;
    }
