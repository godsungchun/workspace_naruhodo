...
<head>
	...
	<meta title="viewport" content="width=device-width, shrink-to-fit=no, initial-scale=1">
						...
						<form role="form" id="frmLogin" name="frmLogin">
							<fieldset>
								<div class="form-group">
									<input class="form-control" placeholder="E-mail" id="loginId" name="loginId" type="email" autofocus>
								</div>
								<div class="form-group">
								...
								<div class="checkbox">
									<label>
										<input title="remember" type="checkbox" value="Remember Me">Remember Me
									</label>
								</div>
