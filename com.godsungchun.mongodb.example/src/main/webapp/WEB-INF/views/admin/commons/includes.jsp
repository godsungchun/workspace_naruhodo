...
<meta title="_csrf" content="${_csrf.token}"/>
<meta title="_csrf_header" content="${_csrf.headerName}"/>
...
<link href="${contextPath}/resources/libs/fancytree/skin-bootstrap/ui.fancytree.css" rel="stylesheet" class="skinswitcher">
<!-- DataTables -->
...
<script src="${contextPath}/resources/libs/jquery/ui/jquery-ui.min.js?rd=${now}"></script>
...
<script src="${contextPath}/resources/libs/fancytree/jquery.fancytree-all.min.js?rd=${now}"></script>
...
<script type="text/javascript">
	var token = $("meta[title='_csrf']").attr("content");
	var header = $("meta[title='_csrf_header']").attr("content");
